...
async def find_correlations(
    dataset_name: str, columns: list[str] | None = None, threshold: float = 0.3
) -> dict:
...
async def detect_outliers(
    dataset_name: str, columns: list[str] | None = None, method: str = "iqr"
) -> dict:
...
async def compare_datasets(
    dataset_a: str, dataset_b: str, common_columns: list[str] | None = None
) -> dict:
...
async def calculate_feature_importance(
    dataset_name: str, target_column: str, feature_columns: list[str] | None = None
) -> dict:
