    ...
    try:
            ...
            if col_type == "object":
                if df[col].apply(lambda x: isinstance(x, str)).all():
                    ...
                    if unique_ratio < 0.5:
                        ...
                        suggestion["potential_savings_kb"] = round(
                            col_memory * 0.6 / 1024, 2
                        )
        ...
        return {
            ...
            "current_memory_usage": {
                ...
                "per_column_kb": {
                    col: round(mem / 1024, 2) for col, mem in memory_usage.items()
                },
            },
