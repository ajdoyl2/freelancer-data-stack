...
class QualityTools:
    ...
    async def create_checkpoint(
        self, checkpoint_name: str, suite_name: str
    ) -> dict[str, Any]:
    ...
    async def profile_dataset(
        self, datasource_name: str, data_asset_name: str
    ) -> dict[str, Any]:
    ...
    async def validate_data(
        self, suite_name: str, checkpoint_name: str | None = None
    ) -> dict[str, Any]:
    ...
    def create_basic_expectation(
        self, column_name: str, expectation_type: str, **kwargs
    ) -> dict[str, Any]:
        """Create a basic expectation configuration."""
        expectation = {
            "expectation_type": expectation_type,
            "kwargs": {"column": column_name, **kwargs},
        }
