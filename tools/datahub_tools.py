...
class DataHubTools:
    ...
    async def search_entities(self, query: str, entity_type: Optional[str] = None) -> Dict[str, Any]:
    ...
    def generate_ingestion_config(self, source_type: str, connection_params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def save_ingestion_config(self, config: Dict[str, Any], filename: str) -> Dict[str, Any]:
