...
class AirflowTools:
    ...
    async def list_dags(self) -> dict[str, Any]:
        ...
        if result["success"]:
            ...
            return {"success": True, "dags": dags, "total_dags": len(dags)}
        return result

    async def trigger_dag(
        self, dag_id: str, execution_date: str | None = None
    ) -> dict[str, Any]:
        """Trigger a DAG run."""
    ...
    def generate_basic_dag(
        self, dag_id: str, description: str, schedule: str = "@daily"
    ) -> str:
